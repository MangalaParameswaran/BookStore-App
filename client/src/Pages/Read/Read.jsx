...
export const Read = () => {
    ...
    const deleteBtn=async(id)=>{
        try {
            setLoading(true)
         let data=await axios.delete(`http://localhost:8000/book/delete/${id}`)
    ...
    useEffect(()=>{
        setLoading(true)
        axios.get(`http://localhost:8000/book/getSingle-book/${id}`).then((res)=>{
            ...
            <section>
                <div className="container-fluid my-5">
                    <div className="row">
                        ...
                        <img src={`http://localhost:8000/uploads/${Books.BookImg_Url}`} height='200' width='400' alt={Books.BookTitle} className="img-fluid my-4 rounded" />
                       <div className="btns">
