...
export const Read = () => {
    ...
    const deleteBtn=async(id)=>{
        try {
            setLoading(true)
         let data=await axios.delete(`https://bookstore-app-3vkr.onrender.com/book/delete/${id}`)
    ...
    useEffect(()=>{
        setLoading(true)
        axios.get(`https://bookstore-app-3vkr.onrender.com/book/getSingle-book/${id}`).then((res)=>{
            ...
            <section>
                <div className="container-fluid my-5">
                    <div className="row">
                        ...
                        <img src={`https://bookstore-app-3vkr.onrender.com/uploads/${Books.BookImg_Url}`} height='200' width='400' alt={Books.BookTitle} className="img-fluid my-4 rounded" />
                       <div className="btns">
                       <div className='edit-btn'>
                        ...
                        <div className='delete-btn'>
                              <button onClick={()=>deleteBtn(Books._id)}> <i className="fa-regular fa-trash-can"></i></button>
                        </div>
                       </div>
                        </div>
